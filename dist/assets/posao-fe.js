...
define('posao-fe/components/basic-dropdown', ['exports', 'ember-basic-dropdown/components/basic-dropdown'], function (exports, _basicDropdown) {
  'use strict';
...
define('posao-fe/components/basic-dropdown/content-element', ['exports', 'ember-basic-dropdown/components/basic-dropdown/content-element'], function (exports, _contentElement) {
  'use strict';
...
define('posao-fe/components/basic-dropdown/content', ['exports', 'ember-basic-dropdown/components/basic-dropdown/content'], function (exports, _content) {
  'use strict';
...
define('posao-fe/components/basic-dropdown/trigger', ['exports', 'ember-basic-dropdown/components/basic-dropdown/trigger'], function (exports, _trigger) {
  'use strict';
...
define('posao-fe/components/rl-dropdown-container', ['exports', 'ember-rl-dropdown/components/rl-dropdown-container'], function (exports, _rlDropdownContainer) {
  'use strict';
...
define('posao-fe/components/rl-dropdown-toggle', ['exports', 'ember-rl-dropdown/components/rl-dropdown-toggle'], function (exports, _rlDropdownToggle) {
  'use strict';
...
define('posao-fe/components/rl-dropdown', ['exports', 'ember-rl-dropdown/components/rl-dropdown'], function (exports, _rlDropdown) {
  'use strict';
...
define('posao-fe/controllers/profile', ['exports'], function (exports) {
  ...
  exports.default = Ember.Controller.extend({
    ...
    actions: {
      ...
      preimenuj: function preimenuj(documentId) {
        var username = this.get("session.data.authenticated.username");
        var newName = this.get("ime");
        if (newName != null) {
          this.get("oglasiService").rename(username, documentId, newName).then(function (x) {
      ...
      showUsers: function showUsers(username) {
...
define('posao-fe/routes/profile', ['exports'], function (exports) {
	...
	exports.default = Ember.Route.extend({
		...
		model: function model() {
			...
			var _korisnici = this.get("korisnikService").all(username);
...
define('posao-fe/services/korisnik-service', ['exports', 'posao-fe/services/base-service', 'posao-fe/models/korisnik'], function (exports, _baseService, _korisnik) {
    'use strict';
...
define("posao-fe/templates/components/rl-dropdown-container", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "7jLi8mBW", "block": "{\"statements\":[[18,\"default\",[[28,[\"dropdownExpanded\"]]]],[0,\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[\"default\"],\"hasPartials\":false}", "meta": { "moduleName": "posao-fe/templates/components/rl-dropdown-container.hbs" } });
});
...
define("posao-fe/templates/index", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "Yb29sMyu", "block": "{\"statements\":[[11,\"div\",[]],[15,\"class\",\"profile-page\"],[13],[0,\"\\n  \"],[11,\"div\",[]],[15,\"class\",\"img img-responsive pozadinaRegistracije cover-screen\"],[13],[14],[0,\"\\n\\n    \"],[11,\"form\",[]],[15,\"class\",\"distinct-page-form col-xs-12 col-sm-10 col-sm-offset-1 col-md-6 col-md-offset-3 col-lg-8 col-lg-offset-2 \"],[13],[0,\"\\n      \"],[11,\"div\",[]],[15,\"class\",\"col-xs-12 text-center\"],[13],[0,\"\\n        \"],[11,\"h1\",[]],[13],[0,\"Dobrodošli \"],[1,[28,[\"session\",\"data\",\"authenticated\",\"username\"]],false],[14],[0,\"\\n        \"],[11,\"br\",[]],[13],[14],[0,\"\\n\"],[6,[\"if\"],[[28,[\"model\",\"oglas\",\"length\"]]],null,{\"statements\":[[0,\"          \"],[11,\"p\",[]],[13],[0,\"U nastavku je dat pregled svih dokumenata koje su drugi korisnici podijelili sa vama, kao i username vlasnika dokumenta. U slučaju da su vam dodijeljenje Edit privilegije nad dokumentom, bit ćete u mogućnosti da promijenite ime dokumenta ili ga obrišete.\"],[14],[0,\"\\n\"]],\"locals\":[]},null],[0,\"      \"],[14],[0,\"\\n    \"],[14],[0,\"\\n\"],[6,[\"if\"],[[28,[\"model\",\"oglas\",\"length\"]]],null,{\"statements\":[[0,\"    \"],[11,\"form\",[]],[15,\"class\",\"distinct-page-form col-xs-12 col-sm-10 col-sm-offset-1 col-md-6 col-md-offset-3 col-lg-8 col-lg-offset-2 \"],[13],[0,\"\\n      \"],[11,\"table\",[]],[13],[0,\"\\n        \"],[11,\"tbody\",[]],[13],[0,\"\\n          \"],[11,\"tr\",[]],[13],[0,\"\\n\"],[6,[\"if\"],[[28,[\"isShowingBody\"]]],null,{\"statements\":[[0,\"                \"],[11,\"td\",[]],[15,\"class\",\"imeInputP\"],[13],[11,\"p\",[]],[13],[0,\"Unesite novo ime dokumenta:\"],[14],[14],[0,\"\\n                \"],[11,\"td\",[]],[15,\"class\",\"imeInput\"],[13],[1,[33,[\"input\"],null,[[\"type\",\"class\",\"id\",\"placeholder\",\"value\"],[\"text\",\"form-control input-sm\",\"newName\",\"Novo ime dokumenta\",[28,[\"ime\"]]]]],false],[14],[0,\"\\n\"]],\"locals\":[]},null],[0,\"          \"],[14],[0,\"\\n\\n\"],[6,[\"each\"],[[28,[\"model\",\"oglas\"]]],null,{\"statements\":[[0,\"          \"],[11,\"tr\",[]],[13],[0,\"\\n            \"],[11,\"td\",[]],[13],[0,\"\\n              \"],[6,[\"if\"],[[33,[\"eq\"],[[28,[\"oglas\",\"datatype\"]],\"text/plain\"],null]],null,{\"statements\":[[11,\"img\",[]],[15,\"class\",\"img-responsive\"],[15,\"src\",\"../assets/images/txt.png\"],[15,\"alt\",\"txt\"],[13],[14],[0,\"\\n              \"]],\"locals\":[]},{\"statements\":[[6,[\"if\"],[[33,[\"eq\"],[[28,[\"oglas\",\"datatype\"]],\"image/png\"],null]],null,{\"statements\":[[11,\"img\",[]],[15,\"class\",\"img-responsive\"],[15,\"src\",\"../assets/images/png.png\"],[15,\"alt\",\"txt\"],[13],[14],[0,\"\\n              \"]],\"locals\":[]},{\"statements\":[[6,[\"if\"],[[33,[\"eq\"],[[28,[\"oglas\",\"datatype\"]],\"application/pdf\"],null]],null,{\"statements\":[[11,\"img\",[]],[15,\"class\",\"img-responsive\"],[15,\"src\",\"../assets/images/pdf.png\"],[15,\"alt\",\"txt\"],[13],[14],[0,\"\\n              \"]],\"locals\":[]},{\"statements\":[[6,[\"if\"],[[33,[\"eq\"],[[28,[\"oglas\",\"datatype\"]],\"image/jpeg\"],null]],null,{\"statements\":[[11,\"img\",[]],[15,\"class\",\"img-responsive\"],[15,\"src\",\"../assets/images/jpg.png\"],[15,\"alt\",\"txt\"],[13],[14],[0,\"\\n              \"]],\"locals\":[]},{\"statements\":[[6,[\"if\"],[[33,[\"eq\"],[[28,[\"oglas\",\"datatype\"]],\"image/jpg\"],null]],null,{\"statements\":[[11,\"img\",[]],[15,\"class\",\"img-responsive\"],[15,\"src\",\"../assets/images/jpg.png\"],[15,\"alt\",\"txt\"],[13],[14],[0,\"\\n              \"]],\"locals\":[]},{\"statements\":[[6,[\"if\"],[[33,[\"eq\"],[[28,[\"oglas\",\"datatype\"]],\"application/vnd.openxmlformats-officedocument.wordprocessingml.document\"],null]],null,{\"statements\":[[11,\"img\",[]],[15,\"class\",\"img-responsive\"],[15,\"src\",\"../assets/images/doc.png\"],[15,\"alt\",\"txt\"],[13],[14],[0,\"\\n              \"]],\"locals\":[]},{\"statements\":[[6,[\"if\"],[[33,[\"eq\"],[[28,[\"oglas\",\"datatype\"]],\"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet\"],null]],null,{\"statements\":[[11,\"img\",[]],[15,\"class\",\"img-responsive\"],[15,\"src\",\"../assets/images/xls.png\"],[15,\"alt\",\"txt\"],[13],[14],[0,\"\\n              \"]],\"locals\":[]},{\"statements\":[[11,\"img\",[]],[15,\"class\",\"img-responsive\"],[15,\"src\",\"../assets/images/other.png\"],[15,\"alt\",\"txt\"],[13],[14]],\"locals\":[]}]],\"locals\":[]}]],\"locals\":[]}]],\"locals\":[]}]],\"locals\":[]}]],\"locals\":[]}]],\"locals\":[]}],[0,\"            \"],[14],[0,\"\\n            \"],[11,\"td\",[]],[13],[6,[\"link-to\"],[\"preview\",[33,[\"query-params\"],null,[[\"id\"],[[28,[\"oglas\",\"id\"]]]]]],null,{\"statements\":[[0,\"\\n            \"],[11,\"p\",[]],[13],[1,[28,[\"oglas\",\"fileName\"]],false],[14],[0,\"\\n            \"]],\"locals\":[]},null],[14],[0,\"\\n            \"],[11,\"td\",[]],[13],[11,\"p\",[]],[13],[1,[28,[\"oglas\",\"owner\",\"username\"]],false],[14],[14],[0,\"\\n            \"],[11,\"td\",[]],[13],[11,\"button\",[]],[15,\"type\",\"button\"],[15,\"id\",\"id_button\"],[15,\"class\",\"btn btn-primary\"],[5,[\"action\"],[[28,[null]],\"toggleBody\",[28,[\"oglas\",\"id\"]]]],[13],[0,\"Preimenuj\"],[14],[14],[0,\"\\n          \"],[14],[0,\"\\n\"]],\"locals\":[\"oglas\"]},null],[0,\"        \"],[14],[0,\"\\n      \"],[14],[0,\"\\n    \"],[14],[0,\"\\n\"]],\"locals\":[]},null],[14],[0,\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"hasPartials\":false}", "meta": { "moduleName": "posao-fe/templates/index.hbs" } });
});
...
define("posao-fe/templates/profile", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "1HJ4q4Dc", "block": "{\"statements\":[[11,\"div\",[]],[15,\"class\",\"profilePage\"],[13],[0,\"\\n\\n  \"],[11,\"form\",[]],[15,\"class\",\"distinct-page-form col-xs-12 col-sm-10 col-sm-offset-1 col-md-6 col-md-offset-3 col-lg-8 col-lg-offset-2 \"],[13],[0,\"\\n    \"],[11,\"div\",[]],[15,\"class\",\"col-xs-12 text-center\"],[13],[0,\"\\n      \"],[11,\"h1\",[]],[13],[0,\"Dobrodošli \"],[1,[28,[\"session\",\"data\",\"authenticated\",\"username\"]],false],[14],[0,\"\\n      \"],[11,\"br\",[]],[13],[14],[0,\"\\n      \"],[11,\"p\",[]],[13],[0,\"Ovo je vaš profil na kojem možete vidjeti sve fajlove koje ste učitali do sada. Kako bi učitali novi fajl, koristite opciju \\\"Drag here or click to upload a file\\\" u gornjem desnom uglu.\"],[14],[0,\"\\n    \"],[14],[0,\"\\n  \"],[14],[0,\"\\n\\n\"],[6,[\"if\"],[[28,[\"model\",\"oglas\",\"length\"]]],null,{\"statements\":[[0,\"  \"],[11,\"form\",[]],[15,\"class\",\"distinct-page-form col-xs-12 col-sm-10 col-sm-offset-1 col-md-6 col-md-offset-3 col-lg-8 col-lg-offset-2 \"],[13],[0,\"\\n    \"],[11,\"table\",[]],[13],[0,\"\\n      \"],[11,\"tbody\",[]],[13],[0,\"\\n        \"],[4,\"<tr>\\n          <form onsubmit = {{action \\\"toggleBody\\\" oglas.id}}>\\n{{#if isShowingBody}}\\n              <td class = \\\"imeInputP\\\"><p>Unesite novo ime dokumenta:</p></td>\\n              <td class = \\\"imeInput\\\">{{input type=\\\"text\\\" class=\\\"form-control input-sm my\\\" id=\\\"newName\\\" placeholder=\\\"Novo ime dokumenta\\\" value=ime}}</td>\\n          {{/if}}        </form>\\n      </tr>\"],[0,\"\\n\"],[6,[\"each\"],[[28,[\"model\",\"oglas\"]]],null,{\"statements\":[[0,\"        \"],[11,\"tr\",[]],[13],[0,\"\\n          \"],[11,\"td\",[]],[13],[0,\"\\n            \"],[6,[\"if\"],[[33,[\"eq\"],[[28,[\"oglas\",\"datatype\"]],\"text/plain\"],null]],null,{\"statements\":[[11,\"img\",[]],[15,\"class\",\"img-responsive\"],[15,\"src\",\"../assets/images/txt.png\"],[15,\"alt\",\"txt\"],[13],[14],[0,\"\\n            \"]],\"locals\":[]},{\"statements\":[[6,[\"if\"],[[33,[\"eq\"],[[28,[\"oglas\",\"datatype\"]],\"image/png\"],null]],null,{\"statements\":[[11,\"img\",[]],[15,\"class\",\"img-responsive\"],[15,\"src\",\"../assets/images/png.png\"],[15,\"alt\",\"txt\"],[13],[14],[0,\"\\n            \"]],\"locals\":[]},{\"statements\":[[6,[\"if\"],[[33,[\"eq\"],[[28,[\"oglas\",\"datatype\"]],\"application/pdf\"],null]],null,{\"statements\":[[11,\"img\",[]],[15,\"class\",\"img-responsive\"],[15,\"src\",\"../assets/images/pdf.png\"],[15,\"alt\",\"txt\"],[13],[14],[0,\"\\n            \"]],\"locals\":[]},{\"statements\":[[6,[\"if\"],[[33,[\"eq\"],[[28,[\"oglas\",\"datatype\"]],\"image/jpeg\"],null]],null,{\"statements\":[[11,\"img\",[]],[15,\"class\",\"img-responsive\"],[15,\"src\",\"../assets/images/jpg.png\"],[15,\"alt\",\"txt\"],[13],[14],[0,\"\\n            \"]],\"locals\":[]},{\"statements\":[[6,[\"if\"],[[33,[\"eq\"],[[28,[\"oglas\",\"datatype\"]],\"image/jpg\"],null]],null,{\"statements\":[[11,\"img\",[]],[15,\"class\",\"img-responsive\"],[15,\"src\",\"../assets/images/jpg.png\"],[15,\"alt\",\"txt\"],[13],[14],[0,\"\\n            \"]],\"locals\":[]},{\"statements\":[[6,[\"if\"],[[33,[\"eq\"],[[28,[\"oglas\",\"datatype\"]],\"application/vnd.openxmlformats-officedocument.wordprocessingml.document\"],null]],null,{\"statements\":[[11,\"img\",[]],[15,\"class\",\"img-responsive\"],[15,\"src\",\"../assets/images/doc.png\"],[15,\"alt\",\"txt\"],[13],[14],[0,\"\\n            \"]],\"locals\":[]},{\"statements\":[[6,[\"if\"],[[33,[\"eq\"],[[28,[\"oglas\",\"datatype\"]],\"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet\"],null]],null,{\"statements\":[[11,\"img\",[]],[15,\"class\",\"img-responsive\"],[15,\"src\",\"../assets/images/xls.png\"],[15,\"alt\",\"txt\"],[13],[14],[0,\"\\n            \"]],\"locals\":[]},{\"statements\":[[11,\"img\",[]],[15,\"class\",\"img-responsive\"],[15,\"src\",\"../assets/images/other.png\"],[15,\"alt\",\"txt\"],[13],[14]],\"locals\":[]}]],\"locals\":[]}]],\"locals\":[]}]],\"locals\":[]}]],\"locals\":[]}]],\"locals\":[]}]],\"locals\":[]}],[0,\"          \"],[14],[0,\"\\n          \"],[11,\"td\",[]],[13],[0,\"\\n\"],[6,[\"link-to\"],[\"preview\",[33,[\"query-params\"],null,[[\"id\"],[[28,[\"oglas\",\"id\"]]]]]],null,{\"statements\":[[0,\"              \"],[11,\"p\",[]],[13],[1,[28,[\"oglas\",\"fileName\"]],false],[14],[0,\"\\n\"]],\"locals\":[]},null],[0,\"          \"],[14],[0,\"\\n          \"],[11,\"td\",[]],[13],[0,\"\\n\"],[6,[\"rl-dropdown-container\"],null,[[\"class\"],[\"dropdown\"]],{\"statements\":[[6,[\"rl-dropdown-toggle\"],null,[[\"class\"],[\"btn btn-primary\"]],{\"statements\":[[0,\"              Podijeli \"],[11,\"span\",[]],[15,\"class\",\"caret\"],[13],[14],[0,\"\\n\"]],\"locals\":[]},null],[0,\"\\n\"],[6,[\"rl-dropdown\"],null,[[\"tagName\",\"class\",\"closeOnChildClick\"],[\"ul\",\"dropdown-menu\",\"button:click\"]],{\"statements\":[[6,[\"each\"],[[28,[\"model\",\"korisnik\"]]],null,{\"statements\":[[0,\"                    \"],[11,\"li\",[]],[13],[0,\"\\n                        \"],[11,\"button\",[]],[15,\"type\",\"button\"],[15,\"id\",\"question\"],[15,\"class\",\"btn btn-primary btn-xs mybtn\"],[5,[\"action\"],[[28,[null]],\"sharingDocument\",[28,[\"oglas\",\"id\"]],[28,[\"korisnik\",\"idKorisnika\"]],[28,[\"NULL\"]]]],[13],[0,\"\\n                          \"],[11,\"p\",[]],[13],[1,[28,[\"korisnik\",\"username\"]],false],[14],[0,\"\\n                        \"],[14],[0,\"\\n                    \"],[14],[0,\"\\n\"]],\"locals\":[\"korisnik\"]},null]],\"locals\":[]},null]],\"locals\":[]},null],[0,\"          \"],[14],[0,\"\\n          \"],[11,\"td\",[]],[13],[1,[33,[\"input\"],null,[[\"type\",\"value\",\"class\",\"placeholder\"],[\"text\",[28,[\"ime\"]],\"form-control\",\"Novo ime dokumenta\"]]],false],[14],[0,\"\\n          \"],[11,\"td\",[]],[13],[11,\"button\",[]],[15,\"type\",\"button\"],[15,\"class\",\"btn btn-primary\"],[5,[\"action\"],[[28,[null]],\"preimenuj\",[28,[\"oglas\",\"id\"]]]],[13],[0,\"Preimenuj\"],[14],[0,\"\\n          \"],[14],[0,\"\\n          \"],[11,\"td\",[]],[13],[11,\"button\",[]],[15,\"type\",\"button\"],[15,\"class\",\"btn btn-primary\"],[5,[\"action\"],[[28,[null]],\"delete\",[28,[\"oglas\",\"id\"]]]],[13],[0,\"Obriši\"],[14],[14],[0,\"\\n        \"],[14],[0,\"\\n\"]],\"locals\":[\"oglas\"]},null],[0,\"      \"],[14],[0,\"\\n    \"],[14],[0,\"\\n  \"],[14],[0,\"\\n\"]],\"locals\":[]},null],[14],[0,\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"hasPartials\":false}", "meta": { "moduleName": "posao-fe/templates/profile.hbs" } });
});
...
if (!runningTests) {
  require("posao-fe/app")["default"].create({"LOG_ACTIVE_GENERATION":true,"LOG_TRANSITIONS":true,"LOG_TRANSITIONS_INTERNAL":true,"LOG_VIEW_LOOKUPS":true,"name":"posao-fe","version":"0.0.0+038685cf"});
}
